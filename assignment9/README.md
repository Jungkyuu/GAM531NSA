...
| Back Wall  | Wall                | AABB     | Solid           |
| Left Wall  | Wall                | AABB     | Solid           |
| Right Wall | Wall                | AABB     | Solid           |
| Box        | Obstacle            | AABB     | Solid           |
| NPC        | Placeholder         | AABB     | Trigger         |
| Door       | Interactable object | AABB     | Solid + Trigger |

Textures for the floor, walls, box, door, and NPC placeholder are stored in:
